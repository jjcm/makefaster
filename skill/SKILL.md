...
1. finds the agent CLIs already installed (Cursor Agent, Claude Code, Codex: it drives *your* install, and never bundles, downloads or hosts a model of its own) and asks which should run the loop **before anything starts**;
